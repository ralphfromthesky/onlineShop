const Header = () => {
  return (
    <div>
      <div className="flex bg-color-1 h-[8rem] justify-center items-center">
      ...
      <div className="h-[2rem] bg-color-2 px-[1rem]">
        ...
        <div className="w-full flex justify-center gap-[5rem]">
          <span>Home</span><span>Analytics</span><span>Men's Wear</span><span>Kid's Wear</span><span>HardWare</span><span>Sex Toys</span><span>Set's</span>
          <span>Air Supply</span><span>Return</span><span>Delivery</span><span></span><span>Items</span><span>Toys</span>
        </div>
      </div>
    </div>
  );
